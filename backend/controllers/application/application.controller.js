...
const updateStatus = async (req, res) => {
  try {
    ...
    if (application.status === "accepted") {
      ...
      text = "Congratulations! Your application for the job has been accepted.";
      html = `
        <div style="font-family: Arial, sans-serif; padding: 20px;">
          ...
          <p style="font-size: 16px;">
            Your application for the job has been accepted. We are excited to have you on board!
          </p>
          <p style="font-size: 14px;">Thank you for applying.</p>
