...
//     <div>
//       <Navbar />
//       <div className="max-w-5xl mx-auto my-24 px-4 sm:px-6 lg:px-8">
...
//                   Required Skills:
//                 </h3>
//                 <p className="text-gray-600">{singleJob?.requirements}</p>
//               </div>
//               <div className="space-y-2">
//                 <h3 className="text-base font-semibold text-gray-700">Role:</h3>
